...
while($row = $resultado->fetch_assoc()){
    ...
    <br><b>Paciente:</b><br>".utf8_encode($row['paciente'])."<br>
    <b>Medico:</b><br>".utf8_encode($row['medico'])."<br>
    <b>Especialidad:</b><br>".utf8_encode($row['especialidad_nombre'])."<br>
    <b>Descripci&oacute;n:</b><br>".utf8_encode($row['cita_descripcion'])."<br>
    .............................................
    <table>
        <tr>
    ...
    Telefono: 968-117-87-39<br>
    Direcci&oacute;n:B.Absalon Cas...
