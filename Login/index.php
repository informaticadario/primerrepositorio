...
<html lang="en">
<head>
	<title>BIENVENIDO AL SISTEMA DEL CDSC</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/imagen1.jpg');">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
						...
						<input class="input100" type="text" name="username" value="admin" placeholder="Escriba el usuario" id="txt_usu" autocomplete="new-password">
						<span class="focus-input100" data-symbol="&#xf206;"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<span class="label-input100">Contrase&ntilde;a</span>
						<input class="input100" type="password" name="pass" value="123456" placeholder="Escriba la contrase&ntilde;a" id="txt_con">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
					</div>
